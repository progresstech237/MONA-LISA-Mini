...
📌 *Select a device below to copy the link:*`;
    ...
    if (buttons.length < 5) {
        buttons.push({
            name: "cta_url",
            buttonParamsJson: JSON.stringify({ display_text: "📢 Channel", url: "https://whatsapp.com/channel/0029Vb7Lk3yAzNbrVaWDOk1P/1086" })
        });
    }
    ...
    const interactiveMsg = {
        interactiveMessage: {
            ...
            footer: { text: "🔹 Powered by Progress Tech • NFToken v1.0 ✓" },
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                serverMessageId: 142,
                newsletterName: 'Tech Toy Channel ✓'
            }
        }
    };
