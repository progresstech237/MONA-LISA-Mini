...
async function sendInteractiveMedia(conn, chatId, result, sender, prefix) {
    try {
        ...
        buttons.push({
            name: "cta_url",
            buttonParamsJson: JSON.stringify({ display_text: "📢 Follow TECH TOY", url: CHANNEL_LINK })
        });
        ...
        const interactiveMsg = {
            interactiveMessage: {
                ...
                body: { text: bodyText },
                footer: { text: "🔹 Powered by Progress Tech • 🥷TECH TOY™ ✓" },
...
cmd({
  pattern: "dl",
  alias: ["download", "downloader", "yt", "tt", "tw", "sn", "bl", "bilibili", "tiktok", "youtube", "twitter", "snapchat"],
  react: "📥",
